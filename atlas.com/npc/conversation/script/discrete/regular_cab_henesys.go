...
// RegularCabHenesys (1012000) is located in Victoria Road - Henesys (100000000)
type RegularCabHenesys struct {
}

func (r RegularCabHenesys) Name() string {
	return "RegularCabHenesys"
}

func (r RegularCabHenesys) Initial(l logrus.FieldLogger) func(ctx context.Context) func(c script.Context) script.State {
...
func (r RegularCabHenesys) Hello(l logrus.FieldLogger) func(ctx context.Context) func(c script.Context) script.State {
	return func(ctx context.Context) func(c script.Context) script.State {
		return func(c script.Context) script.State {
...
func (r RegularCabHenesys) MoreToSee(l logrus.FieldLogger) func(ctx context.Context) func(c script.Context) script.State {
	return func(ctx context.Context) func(c script.Context) script.State {
		return func(c script.Context) script.State {
			m := message.NewBuilder().
...
func (r RegularCabHenesys) WhereToGo(l logrus.FieldLogger) func(ctx context.Context) func(c script.Context) script.State {
	return func(ctx context.Context) func(c script.Context) script.State {
		return func(c script.Context) script.State {
			m := message.NewBuilder()
